          ...
          <section className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            {products.map((product) => (
              <button
                ...
                className="rounded-2xl border border-slate-200 bg-white p-5 text-left shadow-sm transition hover:-translate-y-0.5 hover:border-orange-300 hover:shadow-lg"
              >
            ...
            <section className="mt-5 rounded-2xl border border-slate-200 bg-white p-4">
              <div className="flex flex-wrap items-center justify-between gap-3">
                ...
                <p className="text-sm font-semibold text-emerald-600">
                  Actual: {selectedProduct.current_price !== null ? `${selectedProduct.current_price.toFixed(2)} EUR` : '-'}
                </p>
              </div>
